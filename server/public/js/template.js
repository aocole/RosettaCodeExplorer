...
Jemplate.templateMap['_task_row.html'] = function(context) {
    ...
    try {
output += '<tr>\n  <th>\n    ';
//line 3 "_task_row.html"
output += context.process('_task_row_th.html');
output += '\n  </th>\n\n  ';
//line 10 "_task_row.html"

// FOREACH 
(function() {
    var list = stash.get('langs');
    ...
    try {
        while (! done) {
            stash.data['lang'] = value;
output += '\n    <td>\n      ';
//line 8 "_task_row.html"
output += context.process('_task_row_td.html');
output += '\n    </td>\n  ';;
...
Jemplate.templateMap['_task_row_td.html'] = function(context) {
    if (! context) throw('Jemplate function called without context\n');
    var stash = context.stash;
    var output = '';

    try {
//line 11 "_task_row_td.html"
if (stash.get('num') == 0) {
output += '\n  <i class="icon-minus-sign"></i>\n';
}
else {
output += '\n  <button data-toggle="button" \n    type="button" \n    data-lang="';
//line 6 "_task_row_td.html"
output += stash.get(['lang', 0, 'path', 0]);
output += '" \n    data-task="';
//line 7 "_task_row_td.html"
output += stash.get(['task', 0, 'path', 0]);
output += '" \n    class="code_link btn">\n    ';
//line 9 "_task_row_td.html"
...
Jemplate.templateMap['_task_row_th.html'] = function(context) {
    if (! context) throw('Jemplate function called without context\n');
    var stash = context.stash;
    var output = '';
...
//line 3 "_task_row_th.html"
output += stash.get(['task', 0, 'url', 0]);
output += '" \n		class="info_link" \n		data-type="Task" \n		data-name="';
//line 6 "_task_row_th.html"
output += stash.get(['task', 0, 'path', 0]);
output += '">\n		';
//line 7 "_task_row_th.html"
output += stash.get(['task', 0, 'name', 0]);
output += '\n	</a>\n</th>';
    }
    catch(e) {
        var error = context.set_error(e, output);
